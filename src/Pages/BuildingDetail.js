...
function BuildingDetailDesktop() {
  ...
  useEffect(() => {
    axios
      .get(
        ` https://focus-targeted-variables-beverage.trycloudflare.com/api/buildings/${id}?populate=uploadfiles.fileupload&filters[zone][$eq]=south`
      )
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(
        ` https://focus-targeted-variables-beverage.trycloudflare.com/api/buildings/${id}?populate=*populate=*&filters[zone][$eq]=south`
      )
      .then((response) => {
  ...
  useEffect(() => {
    ...
    const instance = axios.create({
      baseURL:
        " https://focus-targeted-variables-beverage.trycloudflare.com/api/",
      headers: {
            ...
            {buildingPlanImages.map((buildingPlan) => (
              <MDBCol md="6" className="ms-4 me-4 px-0">
                <img
                  ...
                  key={buildingPlan.id}
                  src={
                    " https://focus-targeted-variables-beverage.trycloudflare.com" +
